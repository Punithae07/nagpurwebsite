         ...
         <div class="row border-bottom">
             <div class="col-sm-6 col-md-4">
                 <div class="widget dark">
                     <img class="mt-5 mb-20" alt="" src="<?php echo e(asset('assets/images/logo-wide-white-2.png')); ?>">
                     <p>St. Mary’s Anglo-Indian Hr. Sec. School (A DON BOSCO INSTITUTION) 110, Armenian Street,
                         Chennai – 600 001</p>
                     <ul class="list-inline mt-5">
                         <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-theme-color-2 mr-5"></i> <a
                                 class="text-gray" href="">044 – 25382152</a> </li>
                         <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-theme-color-2 mr-5"></i>
                             <a class="text-gray" href="">stmarys.aihss@gmail.com</a>
                         </li>
                         <li class="m-0 pl-10 pr-10"> <i class="fa fa-globe text-theme-color-2 mr-5"></i> <a
                                 class="text-gray" href="">stmarysaihss.com</a> </li>
                     </ul>
                 </div>
             </div>
             <div class="col-sm-6 col-md-4">
                 <div class="widget dark">
                     <h4 class="widget-title" style="padding-left: 12px;">Useful Links</h4>
                     ...
                     <div class="opening-hours">
                         <ul class="list-border">
                             ...
                             <li class="clearfix"> <span> Fri : </span>
                                 <div class="value pull-right"> 8.00 pm - 6.00 pm </div>
                             </li>
...
<?php /**PATH C:\laragon\www\wp-filament-admin\resources\views/frontend/includes/footer.blade.php ENDPATH**/ ?>